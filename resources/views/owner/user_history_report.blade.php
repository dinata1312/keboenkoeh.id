            ...
            <table class="text-left w-full border-collapse"> <!--Border collapse doesn't work on this site yet but it's available in newer tailwind versions -->
                <thead>
                    <tr>
                        ...
                        <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light text-center">Gambar</th>
                    </tr>
                </thead>
                <tbody>
                    @php
                    ...
                    @foreach ($data as $dt)
                        <tr class="hover:bg-grey-lighter">
                            ...
                            <td class="py-4 px-6 border-b border-grey-light" align="center"><img src="{{ asset('../' . $dt->image) }}" width="200"></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
