<x-app-layout>
    <div class="w-full mt-12">
        <p class="text-xl pb-3 flex items-center">
            ...
            &nbsp;
            <a class="px-1 py-1 text-white text-sm font-light tracking-wider bg-green-500 rounded" href="{{ url('/owner/add-penjualan') }}">Tambah jumlah hasil panen</a>
        </p>
                    ...
                    @foreach ($datas as $data)
                        <tr class="hover:bg-grey-lighter">
                            ...
                            <td class="py-4 px-6 border-b border-grey-light">
                                ...
                                @endif
                            <td class="py-4 px-6 border-b border-grey-light">
                                <a class="px-4 py-1 text-white font-light tracking-wider bg-blue-900 rounded" href="{{ url('owner/detail-penjualan/'. $data->id ) }}">Detail</a>
                                <a class="px-4 py-1 text-white font-light tracking-wider bg-green-900 rounded" href="{{ url('owner/edit-penjualan/'. $data->id ) }}">edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
