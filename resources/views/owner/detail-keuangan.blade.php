        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
            ...
            @php
                if($data->type == 'expense'){
                    echo '<input class="w-full px-2 py-2 text-gray-700 bg-gray-50 rounded" id="amount" name="amount" type="text" readonly required="" value="Pengeluaran">';
                }else{
                    echo '<input class="w-full px-2 py-2 text-gray-700 bg-gray-50 rounded" id="amount" name="amount" type="text" readonly required="" value="Pemasukan">';
                }
            @endphp
        </div>
        <br>
