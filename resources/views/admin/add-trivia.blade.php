<x-app-layout>
    <form class="p-10 bg-white rounded shadow-xl" action="{{ url('/add-informasi') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
            ...
            <input type="radio" value="1" name="status" class="px-2 py-2 text-gray-700 bg-gray-50 rounded"> Publish &nbsp;
